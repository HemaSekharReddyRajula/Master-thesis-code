...
for idid in range(1,5,1):
	#Runing edgeR method
	#f_edge = open('/home/hema/Desktop/Modified_Data/Data/simulated_out'+str(idid)+'.txt', 'r')
	f_edge = open('/home/hema/Desktop/table/edgeR'+str(idid)+'.txt', 'r')
	fo_edge = f_edge.readlines()
	#print fo_edge
...
#Iterating through 20 samples of paired end and bwa mapping commands.
for i in range(1,21,1):
	if i<10:
		m='0'+str(i)
	else:
		m=str(i)
	f_edge = open('/home/hema/Desktop/Methods/simulated_reads/sample_'+m+'_1.fasta', 'r')
	f_edge1 = open('/home/hema/Desktop/Methods/simulated_reads/sample_'+m+'_2.fasta', 'r')
	os.system('bwa.kit/bwa index /home/hema/Desktop/Methods/simulated_reads/chr22.fa')
	...
	os.system('bwa.kit/samtools idxstats aln-pe_sample_'+m+'_sorted.bam > /home/hema/Desktop/output/sample_'+m+'-mapped-readcount.txt')
...
#Matrix of number of mapped reads, Transcript name as row headings and sample names are column headings.
foo=[]
for i in range(1,21,1):
	if i<10:
		m='0'+str(i)
	...
	file = open('/home/hema/Desktop/output/sample_'+m+'-mapped-readcount.txt', 'r')
	foo1 =file.readlines()
	foo.append(foo1)
#print len(file1)
...
#Writing a file.
    ...
    w = csv.writer(open("/home/hema/Desktop/matrix.csv","w"))
    w.writerows(zip(*e))

with open('/home/hema/Desktop/matrix.csv') as f:
	r = csv.reader(f)
	data = [line for line in r]
with open('/home/hema/Desktop/matrix1.csv','w') as f:
	w = csv.writer(f)
